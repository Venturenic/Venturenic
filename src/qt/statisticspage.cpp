...
void StatisticsPage::updateStatistics()
{
    ...
    QString ModifierIntervalSwitch = QString::number(MODIFIER_INTERVAL_SWITCH);

    ui->labelPhasePoW->setText("PoW = Block 0 - " + LastPoWBlock);
    ui->labelPhasePoS->setText("PoS = Block " + ModifierIntervalSwitch + " ∞ ");
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " VTN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " VTN" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " VTN");
    }
